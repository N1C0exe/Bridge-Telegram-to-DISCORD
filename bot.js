...
const banned1 = "HOW TO Open Links Check Here: https://t.me/PremiumHostTuts/3"
...
function parseTelegramMD(text, entities) {
    ...
    let toEdit = text
    entities.forEach((el) => {
        let marked2 = text.substring(el.offset, el.offset + el.length);
        let marked = message.content.substring(banned1.length).split(" ");
    let change = marked;
    switch (el.type) {
